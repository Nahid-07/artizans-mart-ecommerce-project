...
const Checkout = () => {
  ...
  useEffect(() => {
    ...
    if (
      customerInfo.area === "insideDhakaSouth" ||
      customerInfo.area === "insideDhakaNorth"
    ) {
      newDeliveryFee = 70;
    } else if (customerInfo.area === "Gazipur") {
      newDeliveryFee = 100;
    } else if (customerInfo.area === "OutSideDhaka") {
      newDeliveryFee = 120;
    }
    setDeliveryFee(newDeliveryFee);
  }, [customerInfo.area]); // Dependency array: runs whenever customerInfo.area changes
